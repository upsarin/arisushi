                    ...
                    <div class="menu-item-inside" >
                        ...
                        <?if($element['wok'] == "y") { ?>
                            <div class="menu-select" style="bottom: 85px;">
                                <select class="menu-select-razmer wok-garnir" id="<?=$element['id'];?>">
                                ...
                                <input type="hidden" id="wok-garnir-<?=$element['id'];?>" value="none" />
                                <a class="menu-select-razmer-bot"></a>
                            </div>
                        <? } ?>
                        <?if($element['wok'] == "y") { ?>
                            <div class="menu-select" style="bottom: 50px;">
                                <select class="menu-select-razmer wok-sous" id="<?=$element['id'];?>">
                                ...
                                <input type="hidden" id="wok-sous-<?=$element['id'];?>" value="none" />
                                <a class="menu-select-razmer-bot"></a>
                            </div>
                        <? } ?>
...
<script>
    $("#menu-items .menu-item .menu-item-inside-url").click(function(){
        ...
        $.ajax({
            ...
            success: function(html){
                ...
                $("#element-window .menu-select-razmer").change(function() {
                    var obj = $("#element-window .menu-select-razmer").val();
                    if(obj == "1/2") {
                        $("#element-window .menu-item-one-half").css({
                            display: "block"
                        });
                        $("#element-window .menu-mass-window-half").css({
                            display: "block"
                        });

                        $("#element-window .menu-item-one").css({
                            display: "none"
                        });
                        $("#element-window .menu-mass-window-one").css({
                            display: "none"
                        });
                    } else {
                        $("#element-window .menu-item-one-half").css({
    ...
    $(".pb-pop-controls-one .plus").click(function(){
        ...
        if($(".menu-item#" + elementId + " .menu-select-razmer.wok-sous")) {
            sous = $(".menu-item#" + elementId + " .menu-select-razmer.wok-sous").val();
        }
        if($(".menu-item#" + elementId + " .menu-select-razmer.wok-garnir")) {
            garnir = $(".menu-item#" + elementId + " .menu-select-razmer.wok-garnir").val();
        }
        console.log(sous, garnir);
